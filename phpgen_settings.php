...
function GetGlobalConnectionOptions()
{
    return
        array(
          'server' => 'localhost',
          'port' => '3306',
          'username' => 'id17944505_three',
          'database' => 'id17944505_gimenforma',
          'password' => 'q9-|i[BnKqaMV|q&',
...
function GetPageInfos()
{
    ...
    $result[] = array('caption' => 'Instructores', 'short_caption' => 'Instructores', 'filename' => 'instructores.php', 'name' => 'instructores', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
